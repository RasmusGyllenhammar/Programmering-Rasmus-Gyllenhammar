...
public class MetoderJavaPhysicsLibrary {
	...
	public static void main(String[] args) {
		...
		// fråga 10, vad är pyramidens volym om basen är 3meter och höjden 3meter?
	...
	/**
	 * Metod 3, Räknar ut vätsketrycket i en vätska vid ett visst djup
	 * 
	...
	/**
	 * Metod 4, Räknar ut vätsketrycket i vatten vid ett visst djup/höjd
	 * 
	...
	/**
	 * Metod 5, räknar ut rörelse energi och då behövs det massan och hastighet
	 * 
	...
	/**
	 * Metod 6, Metoden räknar ut lägesenergi och man kan sätta in vilka värden man vill
	 * 
	...
	/**
	 * Metod 7, Beräknar hur snabbt man faller ner, hur hastigheten blir när man faller.
	...
	/**
	 * Metod 8, Beräknar skillnaden mellan två tal,
	 * 
	...
	/**
	 * Metod 9, Omvandlar en viss volym av vätska till massa
	 * 
	...
	/**
	 * Metod 11, Denna metod gör om volym till massa av en viss materia
	 * 
	...
	/**
	 * Metod 12, Räknar ut medelhastigheten med hjälp av sträcka och tid
	 * 
	...
	/**
	 * Metod 13, Räknar ut sträckan med hastighet och tid
	 * 
	...
	/**
	 * Metod 14, Metoden räknar ut tiden med en hastighet och sträcka
	 * 
	 * @param distance Värdet för sträckan läggs in här
	 * @param velocity värdet för hastigheten läggs in här
	 * @return Man får tiden tillbaka som det tar för att åka en viss sträcka med en
	 *         speciell hastighet
	 */
	...
	/**
	 * Metod 15, räknar ut arbete med kraft och en sträcka
	 * 
	 * @param force    kraften(F) som vi tar in
	 * @param distance sträckan som objektet flyttats i
	 * @return skickar tillbaka hur stort arbete man gjort beroende på force och
	 *         distance
	 */
	...
	/**
	 * Metod 16, Räknar ut effekt(watt) med arbete och tid värden
	 * 
	...
	/**
	 * Metod 17, Räknar ut energin som krävs för att värma upp ämnet i ett angivet grader
	 * 
	 ...
	 * @return skickar tillbaka hur mycket energi som behövs för att värma upp iron
	 *         i detta fallet
	 */
	...
	/**
	 * Metod 18, Räknar ut hur mycket energi det behövs för att värma upp vätskan med en viss
	 * massa
	 * 
	 * @param fluid  ämnet vi tar in, en vätska
	 * @param mass   massan av vätskan
	 * @param deltaT temperatur skillnaden
	 * @return Skickar tillbaka hur mycket energi det behövs för att värma upp
	 *         vätskan i antal massa
	 */
	...
	/**
	 * Metod 19, Räknar ut mängden energi det behövs för att värma upp en gas med speciell massa
	 * 
	 * @param gas    ämnet vi tar in, en gas i detta fallet, t.ex air
	 * @param mass   Massan av den specifika gasen
	 * @param deltaT temperatur skillnaden
	 * @return Skickar tillbaka hur mycket energi det behövs för att värma upp en
	...
	/**
	 * Metod 20, Räknar ut hur högt ett föremål med en viss hastighet uppåt kommer
	 * 
	...
	/**
	 * Metod 21, fråga 6, Räknar ut effekt med hjälp av att räkna ut rörelse energi
	 * 
	...
	/**
	 * Metod 22, fråga 7, Räknar ut antalet studsar den gör efter att förloraa 1% av
	...
	/**
	 * Metod 23, FRÅGA 8(EGEN FRÅGA), Konverterar km/h till m/s
	 * 
	...
	/**
	 * Metod 24, FRÅGA 9(EGEN FRÅGA), Gör om m/s till Km/h
	 * 
	...
	/**
	 * Metod 25, Räknar ut kraften för ett föremål i fart.
	 * 
	...
	/**
	 * Metod 26, Räknar ut accelerationen med hjälp av kraft och massan
	 * 
	...
	/**
	 * Metod 27, Räknar ut impulsen på ett objekt som utsätts för en konstant kraft
	 * under tiden delta_T
	 * 
	...
	/**
	 * metod 28, räknar ut densiteten med hjälp av massan och volymen
	 * 
	...
	/**
	 * Metod 29, Räknar ut accelerationen med hastighet och tid
	 * 
	...
	/**
	 * Metod 30, Räknar ut volymen av en pyramid med basen och längden
	 * 
